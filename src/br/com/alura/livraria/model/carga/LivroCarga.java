...
public class LivroCarga {
	...
	public static void main(String[] args) {
		...
		dao.persist(createLivro("Imgordehtoror", "85-359-0277-3", 199.90, "11/11/1996"));
	...
	private static Livro createLivro(String titulo, String isbn, Double preco, String dataLancamento){
